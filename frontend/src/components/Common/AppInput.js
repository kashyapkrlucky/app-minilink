...
const AppInput = ({
  ...
  const baseStyles = "rounded-lg border focus:outline-none transition-all duration-300";
  ...
  return (
    <div className="w-full">
      {label && <label className="block text-gray-700 font-medium mb-2 text-xs uppercase tracking-wide">{label}</label>}
      <input
        type={type}
