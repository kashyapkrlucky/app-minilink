...
import { ExclamationCircleIcon, InboxIcon, MagnifyingGlassIcon } from "@heroicons/react/24/outline";
...
const NoResults = ({ content = "No results found.", theme = "default", className = "" }) => {
